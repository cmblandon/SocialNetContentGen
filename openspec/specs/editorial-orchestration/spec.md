# Editorial Orchestration Specification

## Purpose
Runs the end-to-end daily editorial cycle (research → curate → write → adapt → approve → publish), owns project memory, delegates to subagents, and enforces the mandatory human-approval gate before publishing.
